...
{
    /// <inheritdoc />
    public partial class EStoreDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "A", "Administrator", "A", "admin@estore.com", "admin@@" },
                    { 2, "B", "User", "B", "a@amail.com", "user@@" },
                    { 3, "C", "User", "C", "b@bmail.com", "user@@" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Chai", 18.00m, 39, 1f },
                    { 2, 1, "Chang", 19.00m, 17, 1f },
                    { 3, 2, "Aniseed Syrup", 10.00m, 13, 1f },
                    { 4, 2, "Chef Anton's Cajun Seasoning", 22.00m, 53, 1f },
                    { 5, 2, "Chef Anton's Gumbo Mix", 21.35m, 0, 1f },
                    { 6, 2, "Grandma's Boysenberry Spread", 25.00m, 120, 1f },
                    { 7, 7, "Uncle Bob's Organic Dried Pears", 30.00m, 15, 1f },
                    { 8, 2, "Northwoods Cranberry Sauce", 40.00m, 6, 1f },
                    { 9, 6, "Mishi Kobe Niku", 97.00m, 29, 1f },
                    { 10, 8, "Ikura", 31.00m, 31, 1f }
                });
        }
